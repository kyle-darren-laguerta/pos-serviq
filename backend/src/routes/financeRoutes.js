...
import { getExpenses, getRevenue, getPartTimeSalaryReport, getMonthlyItemSold, getIngredientExpenses } from '../controller/financeController.js';

const route = express.Router();

route.get('/revenue/:startDate/:endDate', getRevenue);
route.get('/expenses/:startDate/:endDate', getExpenses);
route.get('/ingredient-expenses/:startDate/:endDate', getIngredientExpenses);
